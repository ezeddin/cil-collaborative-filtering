    ...
    with open(filename, 'w') as write_file:
        ...
        with open(SUBMISSION_EXAMPLE, 'r') as example_file:
            ...
            for i, l in enumerate(lines[1:]):
                ...
                write_file.write(SUBMISSION_FORMAT.format(user+1, item+1, np.round(matrix[item,user], ROUND)))
...
if MODEL == 'average':
    ...
    predictions = svd_prediction(average_prediction(training_data), K=15)
